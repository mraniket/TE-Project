<div class="row">
    <div class="col-md-12">
      	<div class="box box-info">
            ...
            <?php echo form_open('sport_info/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="from_date" value="<?php echo $this->input->post('from_date("Y-m-d")'); ?>" class="has-datepicker form-control" id="from_date" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="to_date" value="<?php echo $this->input->post('to_date("Y-m-d")'); ?>" class="has-datepicker form-control" id="to_date" />
