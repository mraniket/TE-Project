...
<body class="hold-transition sidebar-mini layout-fixed">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="<?php echo site_url('student/index');?>" class="nav-link">Home</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
    ...
    <form class="form-inline ml-3">
      <div class="input-group input-group-sm">
        ...
        <div class="input-group-append">
             ...
             <a href="<?php echo site_url('student_registartion/edit'); ?>" class="btn btn-info btn-xs"><span class="fa fa-pencil"></span> Edit profile</a>
          </button>
        </div>
      </div>
    </form>
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        <div class="input-group-append">
             ...
             <a href="<?php echo site_url('student/logout'); ?>" class="btn btn-info btn-xs"><span class="fa fa-pencil"></span> Logout</a>
          </button>
        </div>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light"><?php echo $student_registartion['name']; ?></span>
    </a>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
           ...
           <li class="nav-item has-treeview menu-open">
            <a href="<?php echo site_url('student/index');?>" class="nav-link active">
